...
def start_U(): # Uart 메세지 받는 함수
    ...
    while True: # 수신 Text 처리
        ...
        if(bytestoread > 0):
            ...
            elif(mode_state == 1): # 자동모드
                if(receive_data == b'\xA5\x3C\xCC\xCC\x5A'): # 캡쳐 제어
                    if(capture_predict() == 0): # ○: 0 패턴정보
                        write_uart(b'\xA5\x30\x00\x11\x5A')
                    elif(capture_predict() == 1): # □: 1 패턴정보
                        write_uart(b'\xA5\x30\x00\x01\x5A')
                    elif(capture_predict() == 2): # △: 2 패턴정보
...
def option_update1():
    ...
    if(c1 == 1): # color 선택이 Red 일때
        if(p1 == 1): # pattern 선택이 ○일 때
            ...
            state1_img = PhotoImage(file="img/auto_img/red_square.png")
        ...
        if(p1 == 1): # pattern 선택이 ○일 때
            ...
            state1_img = PhotoImage(file="img/auto_img/green_square.png")
        ...
        if(p1 == 1): # pattern 선택이 ○일 때
            ...
            state1_img = PhotoImage(file="img/auto_img/blue_square.png")
...
def option_update2():
    ...
    if(c2 == 1): # color 선택이 Red 일때
        if(p2 == 1): # pattern 선택이 ○일 때
            ...
            ack_check(b'\xA5\x4A\x11\x10\x5A')
            state2_img = PhotoImage(file="img/auto_img/red_square.png")
        ...
        if(p2 == 1): # pattern 선택이 ○일 때
            ...
            ack_check(b'\xA5\x4A\x01\x10\x5A')
            state2_img = PhotoImage(file="img/auto_img/green_square.png")
        ...
        if(p2 == 1): # pattern 선택이 ○일 때
            ...
            ack_check(b'\xA5\x4A\x10\x10\x5A')
            state2_img = PhotoImage(file="img/auto_img/blue_square.png")
...
def option_update3():
    ...
    if(c3 == 1): # color 선택이 Red 일때
        if(p3 == 1): # pattern 선택이 ○일 때
            ...
            ack_check(b'\xA5\x4A\x11\x10\x5A')
            state3_img = PhotoImage(file="img/auto_img/red_square.png")
        ...
        if(p3 == 1): # pattern 선택이 ○일 때
            ...
            ack_check(b'\xA5\x4A\x01\x10\x5A')
            state3_img = PhotoImage(file="img/auto_img/green_square.png")
        ...
        if(p3== 1): # pattern 선택이 ○일 때
            ...
            ack_check(b'\xA5\x4A\x10\x10\x5A')
            state3_img = PhotoImage(file="img/auto_img/blue_square.png")
...
def auto_mode_start(event):
    ...
    if(mode_state == 1 and auto_state == 0):
        ...
        ack_check(b'\xA5\x2A\xFF\xFF\x5A') # 임시 Ack
...
mark_img = PhotoImage(file="img/mark.png")
