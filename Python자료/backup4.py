...
def option_update1():
    ...
    if(c1 == 1): # color 선택이 Red 일때
        if(p1 == 1): # pattern 선택이 ○일 때
            ...
            log_update("A 상자 → Red, Star 분류 Set")
        ...
        if(p1 == 1): # pattern 선택이 ○일 때
            ...
            log_update("A 상자 → Green, Star 분류 Set")
        elif(p1 == 3): # pattern 선택이 △일 때
        ...
        if(p1 == 1): # pattern 선택이 ○일 때
            ...
            log_update("A 상자 → Blue, Star 분류 Set")
        elif(p1 == 3): # pattern 선택이 △일 때
...
def option_update2():
    ...
    if(c2 == 1): # color 선택이 Red 일때
        if(p2 == 1): # pattern 선택이 ○일 때
            ...
            log_update("B 상자 → Red, Star 분류 Set")
        ...
        if(p2 == 1): # pattern 선택이 ○일 때
            ...
            log_update("B 상자 → Green, Star 분류 Set")
        elif(p2 == 3): # pattern 선택이 △일 때
        ...
        if(p2 == 1): # pattern 선택이 ○일 때
            ...
            log_update("B 상자 → Blue, Star 분류 Set")
        elif(p2 == 3): # pattern 선택이 △일 때
...
def option_update3():
    ...
    if(c3 == 1): # color 선택이 Red 일때
        if(p3 == 1): # pattern 선택이 ○일 때
            ...
            log_update("C 상자 → Red, Star 분류 Set")
        ...
        if(p3 == 1): # pattern 선택이 ○일 때
            ...
            log_update("C 상자 → Green, Star 분류 Set")
        elif(p3 == 3): # pattern 선택이 △일 때
        ...
        if(p3== 1): # pattern 선택이 ○일 때
            ...
            log_update("C 상자 → Blue, Star 분류 Set")
        elif(p3 == 3): # pattern 선택이 △일 때
